...
//       <motion.div
//         className="relative bg-darkBg/50 rounded-lg overflow-hidden border border-primary/20 transition-all duration-300"
...
//           <motion.div
//             className="absolute inset-0 bg-darkBg/70"
//             initial={{ opacity: 0 }}
